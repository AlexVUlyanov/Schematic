...
#define pinSlaveSelect_OUTPUT	GPIO_Init (GPIOB,GPIO_Pin_4,GPIO_Mode_Out_PP_Low_Fast);
#define pinSlaveSelect_LOW		GPIO_WriteBit(GPIOB,GPIO_Pin_4,RESET);
#define pinSlaveSelect_HIGH		GPIO_WriteBit(GPIOB,GPIO_Pin_4,SET);

#define pinReset_OUTPUT	       GPIO_Init (GPIOD,GPIO_Pin_2,GPIO_Mode_Out_PP_Low_Fast);
#define pinReset_LOW		GPIO_WriteBit(GPIOD,GPIO_Pin_2,RESET);
#define pinReset_HIGH		GPIO_WriteBit(GPIOD,GPIO_Pin_2,SET);
